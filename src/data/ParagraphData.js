...
export const story1 = {
  ...
  text: "그리너지의 ‘포테르' 전지는 고효율과 고성능을 지닌 배터리 그 이상의 가치를 창조하는\n그리너지의 혁신입니다. 다른 2차전지들과 차별화되는 핵심 기술을 필두로 글로벌 2차전지의\n인간과 환경 그리고 미래의 푸른 혁신을 위해 전진하여 빠르게 변화하는 2차전지 시장의\n선두주자로 자리매김 하겠습니다.",
};
...
export const story3 = {
  title: "그 리 너 지 미 션",
  text: "그리너지는 환경과 미래 그리고 인간을 위한 에너지 혁신을 일으켜 미래를 앞당깁니다.\n새로운 혁신인 '포테르' 전지를 앞세워 2차전지 시장을 극복하여 다양한 배터리 시장\n진출해 전지 시장의 선두주자로 앞서 나갈 것입니다.",
};
